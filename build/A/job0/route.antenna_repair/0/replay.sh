...
CD_WORK="/sc_work/build/A/job0/route.antenna_repair/0"
PRINT=""
CMDPREFIX=""
SKIPEXPORT=0
DONODE=0
...
case $PRINT in
    ...
    "directory")
        ...
        ;;
    "command")
        echo "openroad /venv/lib/python3.10/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_antenna_repair.tcl -no_init -metrics reports/metrics.json -exit"
        exit 0
        ;;
esac
