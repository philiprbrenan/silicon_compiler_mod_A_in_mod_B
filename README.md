...
Verilog [module](https://en.wikipedia.org/wiki/Modular_programming) as a reusable macro, and then instantiate it multiple times in
another [module](https://en.wikipedia.org/wiki/Modular_programming) by:

1. Writing a simple Verilog [module](https://en.wikipedia.org/wiki/Modular_programming) **A**
...
All these steps are contained in the single Python [script](https://en.wikipedia.org/wiki/Scripting_language) detailed below.
...
These files will contain the Verilog generated by this [script](https://en.wikipedia.org/wiki/Scripting_language). 
...
The following [code](https://en.wikipedia.org/wiki/Computer_program) will build [module](https://en.wikipedia.org/wiki/Modular_programming) **A** with the Silicon Compiler default
``ASIC`` flow:
...
during the processing of [module](https://en.wikipedia.org/wiki/Modular_programming) **A**.
