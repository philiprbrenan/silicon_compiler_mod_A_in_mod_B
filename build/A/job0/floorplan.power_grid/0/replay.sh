...
CD_WORK="/sc_work/build/A/job0/floorplan.power_grid/0"
PRINT=""
CMDPREFIX=""
SKIPEXPORT=0
DONODE=0
...
case $PRINT in
    ...
    "directory")
        ...
        ;;
    "command")
        echo "openroad /venv/lib/python3.10/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_power_grid.tcl -no_init -metrics reports/metrics.json -exit"
        exit 0
        ;;
esac
