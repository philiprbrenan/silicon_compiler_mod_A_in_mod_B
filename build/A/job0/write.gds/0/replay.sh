...
CD_WORK="/sc_work/build/A/job0/write.gds/0"
PRINT=""
CMDPREFIX=""
SKIPEXPORT=0
DONODE=0
...
case $PRINT in
    ...
    "directory")
        ...
        ;;
    "command")
        echo "klayout -z -nc -rx -r /venv/lib/python3.10/site-packages/siliconcompiler/tools/klayout/scripts/klayout_export.py -rd SC_KLAYOUT_ROOT=/venv/lib/python3.10/site-packages/siliconcompiler/tools/klayout/scripts -rd SC_TOOLS_ROOT=/venv/lib/python3.10/site-packages/siliconcompiler/tools"
        exit 0
        ;;
esac
...
klayout \
  ...
  -rx \
  -r \
  /venv/lib/python3.10/site-packages/siliconcompiler/tools/klayout/scripts/klayout_export.py \
  -rd SC_KLAYOUT_ROOT=/venv/lib/python3.10/site-packages/siliconcompiler/tools/klayout/scripts \
